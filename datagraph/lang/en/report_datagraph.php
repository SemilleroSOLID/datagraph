...
/**
 * Strings for component 'report_datagraph', language 'en'
 *
...
$string['pluginname'] = 'Data Graph';
$string['printmode'] = 'Printable';
$string['privacy:metadata'] = 'The datagraph report only shows data stored in other locations.';
$string['datagraph:view'] = 'View datagraph course report';
$string['settings:displayname:default'] = 'datagraph';
...
$string['settings:flatnav:description'] = 'If checked, a link to the datagraph report will be added to the Boost flat navigation.
...
$string['settings:size_larges'] = 'Size: Larges';
$string['settings:size_larges:description'] = 'User image size in pixels for "Large"';
$string['settings:size_mediums'] = 'Size: Mediums';
$string['settings:size_mediums:description'] = 'User image size in pixels for "Medium"';
$string['settings:size_smalls'] = 'Size: Smalls';
$string['settings:size_smalls:description'] = 'User image size in pixels for "Small"';  */
$string['size:smalls'] = 'Yimmy';
$string['size:mediums'] = 'MediumS';
$string['size:larges'] = 'LargeS';
